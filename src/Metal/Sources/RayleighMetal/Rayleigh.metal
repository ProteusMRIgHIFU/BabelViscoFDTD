...
kernel void ForwardSimpleMetal(const device float *c_wvnb_real [[ buffer(0) ]],
                               ...
                               const device float *r2pr        [[ buffer(3) ]],
                               const device float *r1pr        [[ buffer(4) ]],
                               const device float *a1pr        [[ buffer(5) ]],
                               const device float *u1_real     [[ buffer(6) ]],
                               const device float *u1_imag     [[ buffer(7) ]],
                               device float *py_data_u2_real   [[ buffer(8) ]],
                               device float *py_data_u2_imag   [[ buffer(9) ]],
