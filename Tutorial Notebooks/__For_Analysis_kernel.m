...
#define __def_MEX_VAR(__NameVar)  (&p_MEX_BUFFER[ ((unsigned long) (p_INDEX_MEX[CInd_ ##__NameVar])) | (((unsigned long) (p_INDEX_MEX[CInd_ ##__NameVar]))<<32) ]) 
#define __def_UINT_VAR(__NameVar)  (&p_UINT_BUFFER[ ((unsigned long) (p_INDEX_UINT[CInd_ ##__NameVar])) | (((unsigned long) (p_INDEX_UINT[CInd_ ##__NameVar]))<<32) ])
